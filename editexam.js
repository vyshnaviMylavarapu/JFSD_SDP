...
const styles = {
  ...
  button: {
    padding: '8px 12px',
    background: 'linear-gradient(to right, #3498db, #2980b9)', // Gradient color
    color: 'white',
    border: 'none',
    borderRadius: '5px',
    cursor: 'pointer',
  ...
  editContainer: {
    ...
    borderRadius: '5px', // Rounded corners for edit form
  ...
  select: {
    ...
    borderRadius: '4px', // Rounded corners for select field
